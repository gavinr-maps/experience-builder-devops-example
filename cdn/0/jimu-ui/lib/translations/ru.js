define({
  ...
  outputStatistics: 'Статистика {name}',
  //nav
  ...
  amount: 'Количество',
  widgetIsNotAvailable: '{widgetName} не доступно.',
  //advanced select
  ...
  removeDataAffectedWidgets: 'Данные используются в следующих виджетах, и их удаление может их повредить.',
  removeDataSource: 'Удалить данные',
  removeDataWarningTip: 'Вы удаляете данные:',
  outputDataWillBeRemovedTogether: 'Выходные данные будут удалены вместе',
  removeSourceWidgetWarningTip: 'Удаление {widgetName} также приводит к удалению выходных данных.',
  removeSourceWidgetAffectedWidgets: 'Следующие виджеты ссылаются на вышеуказанные данные, их работа может быть нарушена.',
  howToRemoveWidgetsTip: 'Выберите виджет, для которого вы хотите удалить данные. Имейте в виду, что они будут удалены с видов всех устройств. Не выбранные виджеты будут сохранены, и вы сможете перенастроить их позже.',
  ...
  imageSelectorBlankStatus: 'Нажмите кнопку \"{UploadString}\", чтобы выбрать изображение с вашего устройства.',
  // theme-components
  ...
  zoomToNormal: 'Масштабировать до 100%',
  ...
  whatsNewStep2Title: 'Источник данных',
  whatsNewStep2Content: 'Поддерживает поиск подслоев на вкладке данных и панелях выбора данных. <br/>Отображает предупреждение при удалении виджетов, выходные данные которых используются другими виджетами.',
  whatsNewStep3Title: 'Конструктор',
  whatsNewStep3Content: 'На страницах с прокруткой виджеты теперь могут связываться с блоками и верхом страницы.',
  whatsNewStep4Title: 'Группа Раздел и экран',
  whatsNewStep4Content: 'Вид или экран теперь могут быть настроены на боковой панели, независимо от настроек панели группы разделов или экранов.',
  whatsNewStep5Title: 'Компоновка',
  whatsNewStep5Content: 'Разрешает настройку соотношения сторон в пикселах или процентах.',
  whatsNewStep6Title: 'Таблица содержания',
  whatsNewStep6Content: 'Наведение курсора на виджет в вынесенном списке приводит к его подсвечиванию в канве.',
  whatsNewStep7Title: 'Информация об объекте',
  whatsNewStep7Content: 'Поддерживает слой сцены.',
  whatsNewStep8Title: 'Таблица',
  whatsNewStep8Content: 'Добавляет предположительные варианты при поиске.<br/>Поддерживает перетаскивание для изменения порядка полей для отображения.',
  whatsNewStep9Title: 'Фильтр и Конструктор выражений SQL',
  whatsNewStep9Content: 'Поддерживает перетаскивание для изменения порядка фильтров.<br/>Поддерживает перетаскивание для изменения порядка значений в заранее подготовленном списке значений. ',
  whatsNewStep10Title: 'Управление полетом',
  whatsNewStep10Content: 'Предлагает новый режим полета - Планирование маршрутов. Он позволяет отображать маршрут с путями или точками облета.',
  whatsNewStep11Title: 'Опрос',
  whatsNewStep11Content: 'Поддерживает выбор черновика опроса из списка имеющихся опросов.<br/>Поддерживает выбор опросов, которые принадлежат другим пользователям, из списка имеющихся, если вход выполнен от имени администратора организации.',
  whatsNewStep12Title: 'Текст',
  whatsNewStep12Content: 'Поддерживает новые единицы измерения размера шрифта: VW (отображаемая ширина).<br/>Позволяет настраивать связь для полнотекстового виджета. ',
  ...
  applyToLargeScreen: 'Применить к устройствам с большими экранами.',
  applyToMediumScreen: 'Применить к устройствам со средними экранами.',
  applyToSmallScreen: 'Применить к устройствам с маленькими экранами.',
  //pagination
  pageNumber: 'Страница {pageNumber}'
});