export default {
  ...
  whatsNewStep2Title: 'Data source',
  whatsNewStep2Content: 'Supports searching sub-layers on both the data tab and select data panels.<br/>Shows a warning popup when deleting widgets whose output data are consumed by other widgets.',
  whatsNewStep3Title: 'Builder',
  whatsNewStep3Content: 'In scrolling pages, widgets now can link to blocks and page top.',
  whatsNewStep4Title: 'Section & Screen group',
  whatsNewStep4Content: 'A view or a screen now can be configured in a side panel independent of the section or screen group setting panel.',
  whatsNewStep5Title: 'Layout',
  whatsNewStep5Content: 'Allows setting an aspect ratio when using either the pixel or percent unit.',
  whatsNewStep6Title: 'Table of content',
  whatsNewStep6Content: 'Hover on a widget in the outline list will also highlight it on the canvas correspondingly.',
  whatsNewStep7Title: 'Feature Info',
  whatsNewStep7Content: 'Supports scene layer.',
  whatsNewStep8Title: 'Table',
  whatsNewStep8Content: 'Adds searching suggestions.<br/>Supports dragging-and-dropping to reorder the fields for initial display.',
  whatsNewStep9Title: 'Filter & SQL Expression Builder',
  whatsNewStep9Content: 'Supports dragging-and-dropping to reorder filters.<br/>Supports dragging-and-dropping to reorder values in the predefined value list. ',
  whatsNewStep10Title: 'Fly Controller',
  whatsNewStep10Content: 'Provides a new fly mode – Plan routes. It allows you to preset routes with points or paths to fly through and showcase.',
  whatsNewStep11Title: 'Survey',
  whatsNewStep11Content: 'Support selecting a draft survey from the list of existing surveys.<br/>Supports selecting surveys that owned by others from the existing survey list if signing in as an organization administrator.',
  whatsNewStep12Title: 'Text',
  whatsNewStep12Content: 'Supports a new font size unit: VW (view width).<br/>Allows setting link for the whole text widget. ',
