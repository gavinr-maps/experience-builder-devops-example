export default {
  ...
  activeMapChanged: 'Active map changed.',
  moveToAddPlaceholder: 'Move to add a placeholder',
  trackLocation: 'Watch location',
  trackLocationNorthUp: 'Watch location and stays north-up',
  trackLocationRotate: 'Watch location and rotates with the device',
  noPermissionTip: 'There was an error. Please check the location permissions on your browser and operating system.',
