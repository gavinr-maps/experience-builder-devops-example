...
`,h=d(9655),u=Object.assign({},n,s.defaultMessages);var m;!function(e){e.Auto="auto",e.SideBySide="side-by-side",e.Stack="stack"}(m||(m={}));class f extends t.React.PureComponent{constructor(o){super(o),this.supportedDsTypes=(0,t.Immutable)([i.DataSourceTypes.WebMap,i.DataSourceTypes.WebScene]),this.getPortUrl=()=>(0,t.getAppStore)().getState().portalUrl,this.onOptionsChanged=(e,t)=>{this.props.onSettingChange({id:this.props.id,config:this.props.config.set(t,e)}),"cardStyle"===t&&this.setState({cardStyle:e})},this.onCardLayoutChange=e=>{this.props.onSettingChange({id:this.props.id,config:this.props.config.set("cardLayout",e)}),this.setState({cardLayoutValue:e})},this.onLegendModeChange=e=>{this.props.onSettingChange({id:this.props.id,config:this.props.config.set("legendMode",e)}),this.setState({legendMode:e})},this.onToggleUseDataEnabled=e=>{this.props.onSettingChange({id:this.props.id,useDataSourcesEnabled:e})},this.onDataSourceChange=e=>{e&&this.props.onSettingChange({id:this.props.id,useDataSources:e})},this.onMapWidgetSelected=e=>{this.props.onSettingChange({id:this.props.id,useMapWidgetIds:e})},this.onUseCustomStyleChanged=e=>{this.props.onSettingChange({id:this.props.id,config:this.props.config.setIn(["style","useCustom"],e)})},this.onFontStyleChanged=e=>{this.props.onSettingChange({id:this.props.id,config:this.props.config.setIn(["style","fontColor"],e)})},this.onBackgroundStyleChange=e=>{var o,i,a;const n={color:e,fillType:s.FillType.FILL};let r=(0,t.Immutable)(null!==(a=null===(i=null===(o=this.props.config)||void 0===o?void 0:o.style)||void 0===i?void 0:i.background)&&void 0!==a?a:{});for(const e in n)switch(e){case"fillType":r.fillType!==n[e]&&(r=r.set("fillType",n[e]));break;case"color":r=r.set("color",n[e]);break;case"image":r=r.set("image",n[e])}this.props.onSettingChange({id:this.props.id,config:this.props.config.setIn(["style","background"],r)})};const{cardLayout:a=m.Auto,cardStyle:n=!1,legendMode:r=e.ShowVisible}=this.props.config;this.state={cardStyle:n,cardLayoutValue:a,legendMode:r}}getDefaultStyleConfig(){return{useCustom:!1,background:{color:"",fillType:s.FillType.FILL},fontColor:""}}getStyleConfig(){return this.props.config.style&&this.props.config.style.useCustom?this.props.config.style:this.getDefaultStyleConfig()}render(){var i,n,r,l,d;let c=null;this.state.cardStyle&&(c=(0,t.jsx)(o.SettingRow,{flow:"wrap",role:"radiogroup"},(0,t.jsx)(g,{value:this.state.cardLayoutValue,onChange:this.onCardLayoutChange,itemsIds:["auto","sideBySide","stack"],itemsOptions:Object.values(m)})));const p=(0,t.jsx)(o.SettingRow,{flow:"wrap",role:"radiogroup"},(0,t.jsx)("div",{style:{marginLeft:"-0.5rem"}},(0,t.jsx)(g,{value:this.state.legendMode,onChange:this.onLegendModeChange,itemsIds:["showVisible","showWithinExtent"],itemsOptions:Object.values(e)})));let f;return f=(null===(i=this.props.config.style)||void 0===i?void 0:i.useCustom)?"block":"none",(0,t.jsx)("div",{css:(S=this.props.theme,t.css`
  ...
  `)},(0,t.jsx)("div",{className:"widget-setting-legend"},(0,t.jsx)(o.SettingSection,{className:"map-selector-section",title:this.props.intl.formatMessage({id:"sourceLabel",defaultMessage:u.sourceLabel}),role:"group","aria-label":this.props.intl.formatMessage({id:"sourceLabel",defaultMessage:u.sourceLabel})},(0,t.jsx)(o.SettingRow,{label:(0,t.jsx)(t.FormattedMessage,{id:"selectMapWidget",defaultMessage:u.selectMapWidget})}),(0,t.jsx)(o.SettingRow,null,(0,t.jsx)(o.MapWidgetSelector,{onSelect:this.onMapWidgetSelected,useMapWidgetIds:this.props.useMapWidgetIds}))),(0,t.jsx)(o.SettingSection,{title:this.props.intl.formatMessage({id:"legendMode",defaultMessage:u.legendMode}),role:"group","aria-label":this.props.intl.formatMessage({id:"legendMode",defaultMessage:u.legendMode})},p),(0,t.jsx)(o.SettingSection,{title:this.props.intl.formatMessage({id:"options",defaultMessage:u.options}),role:"group","aria-label":this.props.intl.formatMessage({id:"options",defaultMessage:u.options})},(0,t.jsx)(o.SettingRow,{label:(0,t.jsx)(t.FormattedMessage,{id:"showBaseMap",defaultMessage:u.showBaseMap})},(0,t.jsx)(s.Switch,{className:"can-x-switch",checked:this.props.config&&this.props.config.showBaseMap||!1,"data-key":"showBaseMap",onChange:e=>{this.onOptionsChanged(e.target.checked,"showBaseMap")},"aria-label":this.props.intl.formatMessage({id:"showBaseMap",defaultMessage:u.showBaseMap})})),(0,t.jsx)(o.SettingRow,{label:(0,t.jsx)(t.FormattedMessage,{id:"cardStyle",defaultMessage:u.cardStyle})},(0,t.jsx)(s.Switch,{className:"can-x-switch",checked:this.props.config&&this.props.config.cardStyle||!1,"data-key":"cardStyle",onChange:e=>{this.onOptionsChanged(e.target.checked,"cardStyle")},"aria-label":this.props.intl.formatMessage({id:"cardStyle",defaultMessage:u.cardStyle})})),c),(0,t.jsx)(o.SettingSection,null,(0,t.jsx)(o.SettingRow,{className:"advanced-setting-row",label:(0,t.jsx)(t.FormattedMessage,{id:"advance",defaultMessage:"Advanced"})},(0,t.jsx)(s.Switch,{className:"can-x-switch",checked:this.getStyleConfig().useCustom||!1,"data-key":"showBaseMap",onChange:e=>{this.onUseCustomStyleChanged(e.target.checked)},"aria-label":this.props.intl.formatMessage({id:"advance",defaultMessage:u.advance})})),(0,t.jsx)("div",{className:"mt-4",style:{display:f}},(0,t.jsx)(o.SettingRow,{label:(0,t.jsx)(t.FormattedMessage,{id:"font",defaultMessage:"Font"})},(0,t.jsx)(a.ThemeColorPicker,{icon:h,type:"with-icon",specificTheme:this.props.theme2,value:this.getStyleConfig().fontColor||(null===(l=null===(r=null===(n=this.props.theme2.arcgis.widgets.legend.variants)||void 0===n?void 0:n.default)||void 0===r?void 0:r.root)||void 0===l?void 0:l.color)||"",onChange:this.onFontStyleChanged,"aria-label":this.props.intl.formatMessage({id:"fontColor",defaultMessage:u.fontColor})})),(0,t.jsx)(o.SettingRow,{label:(0,t.jsx)(t.FormattedMessage,{id:"background",defaultMessage:"Background"})},(0,t.jsx)(a.ThemeColorPicker,{specificTheme:this.props.theme2,value:(null===(d=this.getStyleConfig().background)||void 0===d?void 0:d.color)||this.props.theme2.sys.color.surface.paper||"",onChange:this.onBackgroundStyleChange,"aria-label":this.props.intl.formatMessage({id:"backgroundColor",defaultMessage:u.backgroundColor})}))))));var S}}f.mapExtraStateProps=e=>({dsJsons:e.appStateInBuilder.appConfig.dataSources});const S=f;function y(e){d.p=e}})(),c})())}}}));