...
`;class w extends s.React.PureComponent{constructor(t){super(t),this.removeSplitHandler=()=>{null!=this.interactable&&(this.interactable.unset(),this.interactable=null)},this.handleToggleSidebar=t=>{t.stopPropagation(),(0,s.getAppStore)().dispatch(s.appActions.widgetStatePropChange(this.props.widgetId,"collapse",!this.props.sidebarVisible))},this.state={isResizing:!1,deltaSize:0}}componentDidMount(){const{firstLayouts:t,secondLayouts:e,config:i}=this.props;null!=t&&null!=e&&this.bindSplitHandler(),(0,s.getAppStore)().dispatch(s.appActions.widgetStatePropChange(this.props.widgetId,"collapse",0!==i.defaultState))}componentDidUpdate(){const{firstLayouts:t,secondLayouts:e}=this.props;null!=t&&null!=e&&null==this.interactable&&this.bindSplitHandler(),null!=this.interactable&&this.interactable.draggable({startAxis:this.props.direction===i.Horizontal?"x":"y",lockAxis:this.props.direction===i.Horizontal?"x":"y"})}componentWillUnmount(){this.removeSplitHandler()}calSidebarSize(){const{config:t}=this.props;let e;return e=0!==this.state.deltaSize?n.utils.isPercentage(t.size)?`${parseFloat(t.size)*this.domSize/100+this.state.deltaSize}px`:`${parseFloat(t.size)+this.state.deltaSize}px`:t.size,e}createCollapsibleSide(e,o){const{config:l,direction:r}=this.props,n=this.calSidebarSize(),a=this.shouldFlipLeftAndRight();let p;p=r===i.Horizontal?s.css`
      ...
      `;const d=this.layoutItemComponent;return(0,s.jsx)("div",{css:s.css`
        ...
        flex-shrink: 0;
        flex-basis: auto;
      `,className:(0,s.classNames)("d-flex",{"flex-column":r===i.Vertical})},(0,s.jsx)(d,{innerLayouts:e,itemStyle:o===t.First?l.firstPanelStyle:l.secondPanelStyle,collapsed:!this.props.sidebarVisible,className:(0,s.classNames)({"h-100":r===i.Vertical,"w-100":r===i.Horizontal})}),this.createController(a))}splitStyle(){const{direction:e,config:o}=this.props,l=this.calSidebarSize(),r=!this.props.sidebarVisible,n=null!=o.divider&&o.divider.visible&&null!=o.divider.lineStyle?c.styleUtils.toCSSBorder(o.divider.lineStyle):"none";return e===i.Horizontal?s.css`
        width: 1px;
        border-left: ${n};
        position: ${o.overlay?"absolute":"relative"};
        left: ${o.overlay&&!r&&o.collapseSide===t.First?l:"auto"};
        right: ${o.overlay&&!r&&o.collapseSide===t.Second?l:"auto"};
        height: ${o.overlay?"100%":"auto"};
        &:after {
          display: ${o.resizable?"block":"none"};
          position: absolute;
          content: '';
          width: 5px;
          top: 0;
      ...
      border-top: ${n};
      position: ${o.overlay?"absolute":"relative"};
      top: ${o.overlay&&!r&&o.collapseSide===t.First?l:"auto"};
      bottom: ${o.overlay&&!r&&o.collapseSide===t.Second?l:"auto"};
      ...
      z-index: 3;
    `}createController(o){const{config:l,theme:r,direction:n}=this.props;if(null!=l.toggleBtn&&!l.toggleBtn.visible)return null;const a=this.props.sidebarVisible?l.toggleBtn.collapseStyle:l.toggleBtn.expandStyle;let p,d,c,u=0,h=0;if(n===i.Horizontal){l.toggleBtn.position===e.Start?p=0:l.toggleBtn.position===e.Center&&(p="50%",h=-l.toggleBtn.height/2);const i=l.collapseSide===t.Second;c=s.css`
      ...
      `;const{style:g}=a,{iconSize:f,width:S,height:y,color:m,icon:x}=l.toggleBtn;return(0,s.jsx)("div",{css:s.css`
        ...
        `},(0,s.jsx)(z,{theme:r,icon:x,iconSize:f,expanded:this.props.sidebarVisible,width:S,height:y,color:m,style:g,shouldFlip:o,onClick:this.handleToggleSidebar}))}createNormalSide(e,i){const o=this.layoutItemComponent,{config:l}=this.props;return(0,s.jsx)("div",{css:this.state.isResizing?"":$,className:"flex-shrink-0 flex-grow-1 d-flex",style:{zIndex:0,flexBasis:this.props.sidebarVisible?"0":"100%",overflow:"auto"}},(0,s.jsx)(o,{itemStyle:i===t.First?l.firstPanelStyle:l.secondPanelStyle,innerLayouts:e,className:"w-100"}))}shouldFlipLeftAndRight(){const{direction:t}=this.props;return t===i.Horizontal&&(0,s.getAppStore)().getState().appContext.isRTL}render(){const{config:e,firstLayouts:o,secondLayouts:l,direction:r}=this.props;return null==o||null==l?(0,s.jsx)(c.Loading,null):(0,s.jsx)(n.PageContext.Consumer,null,(n=>{const a=n.builderTheme;return(0,s.jsx)("div",{className:(0,s.classNames)("d-flex w-100",{"flex-column":r===i.Vertical}),ref:t=>this.ref=t,css:s.css`
          ...
          `},e.collapseSide===t.First?this.createCollapsibleSide(o,t.First):this.createNormalSide(o,t.First),(0,s.jsx)("div",{css:this.splitStyle(),ref:t=>this.splitRef=t}),e.collapseSide===t.Second?this.createCollapsibleSide(l,t.Second):this.createNormalSide(l,t.Second))}))}}const F={SidebarLayoutBuilder:class extends w{constructor(e){super(e),this.bindSplitHandler=()=>{let e,o;null!=this.splitRef&&null==this.interactable&&(this.interactable=(0,l.interact)(this.splitRef).origin("parent").draggable({inertia:!1,autoScroll:!1,modifiers:[l.interact.modifiers.restrict({restriction:"parent"})],startAxis:this.props.direction===i.Horizontal?"x":"y",lockAxis:this.props.direction===i.Horizontal?"x":"y",onstart:t=>{t.stopPropagation(),e=0,o=0;const s=this.ref.getBoundingClientRect();this.domSize=this.props.direction===i.Horizontal?s.width:s.height,this.setState({isResizing:!0})},onmove:s=>{if(s.stopPropagation(),e+=s.dx,o+=s.dy,this.props.direction===i.Horizontal){const i=n.utils.isRTL()?-1:1;this.props.config.collapseSide===t.First?this.setState({deltaSize:Math.round(e*i)}):this.setState({deltaSize:-Math.round(e*i)})}else this.props.config.collapseSide===t.First?this.setState({deltaSize:Math.round(o)}):this.setState({deltaSize:-Math.round(o)})},onend:t=>{t.stopPropagation();const{config:e}=this.props,i=this.state.deltaSize;let o;o=n.utils.isPercentage(e.size)?`${(100*(parseFloat(e.size)*this.domSize/100+i)/this.domSize).toFixed(4)}%`:`${(parseFloat(e.size)+i).toFixed(0)}px`,(0,r.getAppConfigAction)().editWidgetConfig(this.props.widgetId,(0,s.Immutable)(e).set("size",o)).exec(),this.setState({deltaSize:0,isResizing:!1})}}))},this.layoutItemComponent=u}}}})(),p})())}}}));