...
`;class ee extends s.React.PureComponent{constructor(e){super(e),this.removeSplitHandler=()=>{null!=this.interactable&&(this.interactable.unset(),this.interactable=null)},this.state={isResizing:!1,deltaSize:0}}componentDidMount(){const{firstLayouts:e,secondLayouts:t}=this.props;null!=e&&null!=t&&this.bindSplitHandler(),this.props.sidebarVisible||h(this.props.widgetId,!1)}componentDidUpdate(e){const{firstLayouts:t,secondLayouts:i}=this.props;null!=t&&null!=i&&null==this.interactable&&this.bindSplitHandler(),null!=this.interactable&&this.interactable.draggable({startAxis:this.props.direction===o.Horizontal?"x":"y",lockAxis:this.props.direction===o.Horizontal?"x":"y"}),e.sidebarVisible!==this.props.sidebarVisible&&h(this.props.widgetId,this.props.sidebarVisible)}componentWillUnmount(){this.removeSplitHandler()}handleToggleSidebar(e){e.stopPropagation(),(0,s.getAppStore)().dispatch(s.appActions.widgetStatePropChange(this.props.widgetId,"collapse",!this.props.sidebarVisible))}calSidebarSize(){const{config:e}=this.props;let t;return t=0!==this.state.deltaSize?r.utils.isPercentage(e.size)?`${parseFloat(e.size)*this.domSize/100+this.state.deltaSize}px`:`${parseFloat(e.size)+this.state.deltaSize}px`:e.size,t}createCollapsibleSide(t,i){const{config:l,direction:n}=this.props,a=this.calSidebarSize(),p=this.shouldFlipLeftAndRight();let c,d=`${a}`;r.utils.isPercentage(a)&&(d="100%"),c=n===o.Horizontal?s.css`
      ...
      `:s.css`
        height: ${a};
        transform: ${l.overlay&&!this.props.sidebarVisible?l.collapseSide===e.First?`translateY(-${d})`:`translateY(${d})`:"none"};
    ...
    `}createController(i){var l,n;const{config:r,direction:a}=this.props;if(!(null==r.toggleBtn||r.toggleBtn.visible||window.jimuConfig.isInBuilder&&(null===(l=window.parent)||void 0===l?void 0:l.isExpressBuilder)))return null;const p=this.props.sidebarVisible?r.toggleBtn.collapseStyle:r.toggleBtn.expandStyle;let c,d,u,g=0,h=0;if(a===o.Horizontal){r.toggleBtn.position===t.Start?c=0:r.toggleBtn.position===t.Center&&(c="50%",h=-r.toggleBtn.height/2);const o=r.collapseSide===e.Second;u=s.css`
      ...
      `;const{style:f}=p,{iconSize:m,width:v,height:x,color:y,icon:S,border:b,iconSource:w}=r.toggleBtn;return(0,s.jsx)("div",{css:s.css`
          ${u}
          position: absolute;
          pointer-events: none;
          width: ${v}px;
        ...
        `},(0,s.jsx)(K,{widgetId:this.props.widgetId,icon:S,iconSize:m,expanded:this.props.sidebarVisible,width:v,height:x,color:y,style:f,shouldFlip:i,border:b,iconSource:w,showAsExpressTip:window.jimuConfig.isInBuilder&&(null===(n=window.parent)||void 0===n?void 0:n.isExpressBuilder)&&null!=r.toggleBtn&&!r.toggleBtn.visible,onClick:this.handleToggleSidebar.bind(this)}))}createNormalSide(t,o){const i=this.layoutItemComponent,{config:l}=this.props;return(0,s.jsx)("div",{css:this.state.isResizing?"":Q,className:"flex-shrink-0 flex-grow-1 d-flex side-normal",style:{zIndex:0,flexBasis:this.props.sidebarVisible?"0":"100%",overflow:"auto"}},(0,s.jsx)(i,{itemStyle:o===e.First?l.firstPanelStyle:l.secondPanelStyle,innerLayouts:t,className:"w-100"}))}shouldFlipLeftAndRight(){const{direction:e}=this.props;if(e===o.Horizontal){return(0,s.getAppStore)().getState().appContext.isRTL}return!1}createContent(){const{config:t,firstLayouts:o,secondLayouts:i}=this.props;return t.overlay?t.collapseSide===e.First?(0,s.jsx)(s.React.Fragment,null,this.createNormalSide(i,e.Second),(0,s.jsx)("div",{css:this.splitStyle(),ref:e=>{this.splitRef=e}}),this.createCollapsibleSide(o,e.First)):(0,s.jsx)(s.React.Fragment,null,this.createNormalSide(o,e.First),(0,s.jsx)("div",{css:this.splitStyle(),ref:e=>{this.splitRef=e}}),this.createCollapsibleSide(i,e.Second)):t.collapseSide===e.First?(0,s.jsx)(s.React.Fragment,null,this.createCollapsibleSide(o,e.First),(0,s.jsx)("div",{css:this.splitStyle(),ref:e=>{this.splitRef=e}}),this.createNormalSide(i,e.Second)):(0,s.jsx)(s.React.Fragment,null,this.createNormalSide(o,e.First),(0,s.jsx)("div",{css:this.splitStyle(),ref:e=>{this.splitRef=e}}),this.createCollapsibleSide(i,e.Second))}render(){const{config:t,firstLayouts:i,secondLayouts:l,direction:n}=this.props;return null==i||null==l?(0,s.jsx)(d.Loading,null):(0,s.jsx)(r.PageContext.Consumer,null,(i=>{const l=i.builderTheme;return(0,s.jsx)("div",{className:(0,s.classNames)("d-flex w-100",{"flex-column":n===o.Vertical}),ref:e=>{this.ref=e},css:s.css`
              ...
              `},this.createContent())}))}}const te={SidebarLayoutBuilder:s.ReactRedux.connect((function(e,t){return{appMode:e.appRuntimeInfo.appMode}}))(class extends ee{constructor(t){super(t),this.bindSplitHandler=()=>{let t,i;null!=this.splitRef&&null==this.interactable&&(this.interactable=(0,l.interact)(this.splitRef).origin("parent").draggable({inertia:!1,autoScroll:!1,modifiers:[l.interact.modifiers.restrict({restriction:"parent"})],startAxis:this.props.direction===o.Horizontal?"x":"y",lockAxis:this.props.direction===o.Horizontal?"x":"y",onstart:e=>{e.stopPropagation(),t=0,i=0;const s=this.ref.getBoundingClientRect();this.domSize=this.props.direction===o.Horizontal?s.width:s.height,this.setState({isResizing:!0})},onmove:s=>{if(s.stopPropagation(),t+=s.dx,i+=s.dy,this.props.direction===o.Horizontal){const o=r.utils.isRTL()?-1:1;this.props.config.collapseSide===e.First?this.setState({deltaSize:Math.round(t*o)}):this.setState({deltaSize:-Math.round(t*o)})}else this.props.config.collapseSide===e.First?this.setState({deltaSize:Math.round(i)}):this.setState({deltaSize:-Math.round(i)})},onend:e=>{e.stopPropagation();const{config:t}=this.props,o=this.state.deltaSize;let i;i=r.utils.isPercentage(t.size)?`${(100*(parseFloat(t.size)*this.domSize/100+o)/this.domSize).toFixed(4)}%`:`${(parseFloat(t.size)+o).toFixed(0)}px`;(0,n.getAppConfigAction)().editWidgetConfig(this.props.widgetId,(0,s.Immutable)(t).set("size",i)).exec(),this.setState({deltaSize:0,isResizing:!1})}}))},this.layoutItemComponent=u}componentDidUpdate(e){const{appMode:t,config:o}=this.props;if(t===s.AppMode.Run&&!o.resizable)return this.splitRef.classList.add("no-resize"),void this.removeSplitHandler();this.splitRef.classList.remove("no-resize"),super.componentDidUpdate(e)}})}})(),c})())}}}));