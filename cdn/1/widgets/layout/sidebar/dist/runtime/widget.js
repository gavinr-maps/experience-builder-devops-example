...
`;class Z extends s.React.PureComponent{constructor(e){super(e),this.removeSplitHandler=()=>{null!=this.interactable&&(this.interactable.unset(),this.interactable=null)},this.state={isResizing:!1,deltaSize:0}}componentDidMount(){const{firstLayouts:e,secondLayouts:t}=this.props;null!=e&&null!=t&&this.bindSplitHandler()}componentDidUpdate(){const{firstLayouts:e,secondLayouts:t}=this.props;null!=e&&null!=t&&null==this.interactable&&this.bindSplitHandler(),null!=this.interactable&&this.interactable.draggable({startAxis:this.props.direction===o.Horizontal?"x":"y",lockAxis:this.props.direction===o.Horizontal?"x":"y"})}componentWillUnmount(){this.removeSplitHandler()}handleToggleSidebar(e){e.stopPropagation(),(0,s.getAppStore)().dispatch(s.appActions.widgetStatePropChange(this.props.widgetId,"collapse",!this.props.sidebarVisible))}calSidebarSize(){const{config:e}=this.props;let t;return t=0!==this.state.deltaSize?l.utils.isPercentage(e.size)?`${parseFloat(e.size)*this.domSize/100+this.state.deltaSize}px`:`${parseFloat(e.size)+this.state.deltaSize}px`:e.size,t}createCollapsibleSide(t,i){const{config:n,direction:r}=this.props,a=this.calSidebarSize(),c=this.shouldFlipLeftAndRight();let p,d=`${a}`;l.utils.isPercentage(a)&&(d="100%"),p=r===o.Horizontal?s.css`
      ...
      `;const u=this.layoutItemComponent;return(0,s.jsx)("div",{css:s.css`
        ...
        flex-shrink: 0;
        flex-basis: auto;
      `,className:(0,s.classNames)("d-flex side-collapsable",{"flex-column":r===o.Vertical})},(0,s.jsx)(u,{innerLayouts:t,itemStyle:i===e.First?n.firstPanelStyle:n.secondPanelStyle,collapsed:!this.props.sidebarVisible,className:(0,s.classNames)({"h-100":r===o.Vertical,"w-100":r===o.Horizontal})}),this.createController(c))}splitStyle(){const{direction:t,config:i,appMode:l}=this.props,n=this.calSidebarSize(),r=!this.props.sidebarVisible,c=null!=i.divider&&i.divider.visible&&null!=i.divider.lineStyle?a.styleUtils.toCSSBorder(i.divider.lineStyle):"none";return t===o.Horizontal?s.css`
        width: 1px;
        touch-action: none;
        user-select: none;
        border-left: ${c};
