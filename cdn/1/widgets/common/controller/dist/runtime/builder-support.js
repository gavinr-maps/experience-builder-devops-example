...
`)(c,u,g),[R,x]=t.hooks.useForwardRef(a),S=((o,a,l=0,r=l)=>{let i=((o,a=500,l)=>{var r,i;const n=l?"clientHeight":"clientWidth",[s,c]=e.React.useState(null!==(i=null===(r=o.current)||void 0===r?void 0:r[n])&&void 0!==i?i:0),d=t.hooks.useLatest((()=>{const e=o.current[n]||0;c(e)})),u=e.React.useMemo((()=>e.lodash.debounce((()=>d.current()),a)),[]);return e.React.useEffect((()=>{const e=o.current;e&&u();const t=new ResizeObserver(u);return t.observe(e),()=>{t.disconnect(),u.cancel()}}),[o,u]),s})(o,500,a);return i+=l,i=Math.max(i,r),i})(R,c,u,g),C=e.React.useMemo((()=>Math.floor(S/d)),[d,S]),[I,j]=e.React.useState(k(0,0,C)[0]),[O,A]=e.React.useState(k(0,0,C)[1]),N=t.hooks.useRefValue(O),P=t.hooks.useRefValue(I),[L,M]=e.React.useState(!0),[z,T]=e.React.useState(!1),[W,B]=e.React.useState(!0),Z=e.React.useMemo((()=>({visibility:W?"hidden":"visible"})),[W]);e.React.useEffect((()=>{null==f||f(W,L,z)}),[z,L,W,f]),e.React.useEffect((()=>{if(0===S)return;const[e,t]=k(P.current,N.current,C);j(e),A(t)}),[C,P,N,S]);const $=e.React.useRef([]),D=t.hooks.useEventCallback((()=>{const e=n.length>0&&$.current.length>0&&n[n.length-1]!==$.current[$.current.length-1];if(h&&e&&$.current.length>b){let e=0,t=0;t=b,e=t-C,e=Math.max(0,e),j(e),A(t)}}));e.React.useEffect((()=>{D(),$.current=n}),[n,D]);const H=t.hooks.useEventCallback(((e,t=!0)=>{const o=t?1:C;let a=0,l=0;e?(a=I-o,a<0?(a=0,l=a+C):l=O-o):(l=O+o,l>b?(l=b,a=l-C):a=I+o),j(a),A(l)}));return e.React.useEffect((()=>{t.utils.setRef(r,H)}),[H,r]),e.React.useEffect((()=>{if(0===S)return;const e=O-I>=b,t=O===b;M(0===I),T(t),B(e)}),[I,O,b,S]),(0,e.jsx)(t.NavButtonGroup,Object.assign({},m,{css:w,type:"tertiary",vertical:c,onChange:e=>{null==p||p(e),H(e,!0)},disablePrevious:L,disableNext:z,previousAriaLabel:y("previous"),nextAriaLabel:y("next"),previousStyle:Z,nextStyle:Z,className:(0,e.classNames)("scroll-list",i)}),(0,e.jsx)("div",{className:"root scroll-list-root",ref:x},n.slice(I,O).map((e=>s(e,"scroll-list-item")))))}));var P=c(25164),L=c.n(P);const M=(0,x.styled)("div")`
  display: flex;
  align-items: center;
  justify-content: center;
...
`,G=e.React.forwardRef(((t,o)=>{var a;const{showPlaceholder:l,itemStyle:r,space:i,vertical:n}=t,s=function(e,t){var o={};for(var a in e)Object.prototype.hasOwnProperty.call(e,a)&&t.indexOf(a)<0&&(o[a]=e[a]);if(null!=e&&"function"==typeof Object.getOwnPropertySymbols){var l=0;for(a=Object.getOwnPropertySymbols(e);l<a.length;l++)t.indexOf(a[l])<0&&Object.prototype.propertyIsEnumerable.call(e,a[l])&&(o[a[l]]=e[a[l]])}return o}(t,["showPlaceholder","itemStyle","space","vertical"]),c=n?i:r.labelGrowth;return e.React.createElement(V,null,l&&e.React.createElement(W,{size:null===(a=r.avatar)||void 0===a?void 0:a.size,space:c,vertical:n}),e.React.createElement(H,Object.assign({className:(0,e.classNames)({invisible:l}),ref:o,itemStyle:r,space:i,vertical:n},s)))})),F=e.css`
  width: 300px;
  height: 300px;
  overflow-y: auto;
`,U={Builder:t=>{var a,r,s,c;const{id:d,config:u,version:p}=t,v=null===(a=null==u?void 0:u.behavior)||void 0===a?void 0:a.vertical,g=null===(r=u.behavior)||void 0===r?void 0:r.size,h=v?"right-start":"bottom",{viewOnly:f}=e.React.useContext(i.PageContext),w=e.React.useRef(null),x=e.ReactRedux.useSelector((e=>e.widgetsState[d])),S=null==x?void 0:x.showWidgetsPanel,C=e.React.useRef(),[I,j]=e.React.useState(null),O=n(d,o),A=!Object.keys(null!=O?O:{}).length,k=Object.keys(O).filter((t=>O[t].state===e.WidgetState.Opened)),E=null==k?void 0:k[0],N=null==g?void 0:g[E];e.React.useEffect((()=>{(0,e.getAppStore)().dispatch(e.appActions.closeWidgets(k))}),[p]);const P=e.React.useCallback(((t,o,a)=>{(0,e.getAppStore)().dispatch(e.appActions.widgetStatePropChange(d,"hideArrow",t)),(0,e.getAppStore)().dispatch(e.appActions.widgetStatePropChange(d,"disablePrevious",o)),(0,e.getAppStore)().dispatch(e.appActions.widgetStatePropChange(d,"disableNext",a))}),[d]);e.React.useEffect((()=>{(0,e.getAppStore)().dispatch(e.appActions.widgetStatePropChange(d,"onArrowClick",C.current))}),[d]);const L=()=>{(0,e.getAppStore)().dispatch(e.appActions.widgetStatePropChange(d,"showWidgetsPanel",!1))},M=R(d,o);return(0,e.jsx)("div",{className:"controller-builder w-100 h-100",ref:w,onClick:e=>{const t=e.target,o=w.current;t&&o&&o.contains(t)&&L()}},E&&(0,e.jsx)(m,{reference:I,version:p,widgetId:E,controllerId:d,size:N,onClose:()=>(0,e.getAppStore)().dispatch(e.appActions.closeWidgets(k)),onSizeChange:(t,o)=>{if(!t)return;let a=(null==u?void 0:u.behavior.size)||(0,e.Immutable)({});a=a.set(t,o),(e=>{(0,l.getAppConfigAction)().editWidgetConfig(d,e).exec()})(u.setIn(["behavior","size"],a))},placement:h}),(0,e.jsx)(G,{scrollRef:C,showPlaceholder:A,onScrollStatusChange:P,vertical:null===(s=null==u?void 0:u.behavior)||void 0===s?void 0:s.vertical,widgetId:d,onItemClick:t=>{var o;if(f)return;const a=t.currentTarget,l=null===(o=a.dataset)||void 0===o?void 0:o.widgetid;j(a),(0,e.getAppStore)().dispatch(e.appActions.closeWidgets(k)),(0,e.getAppStore)().dispatch(e.appActions.openWidget(l))},itemStyle:u.appearance.card,draggable:!0,markerEnabled:!f,space:null===(c=null==u?void 0:u.appearance)||void 0===c?void 0:c.space}),S&&(0,e.jsx)(y.WidgetListPopper,{css:F,placement:"right-start",referenceElement:w.current,isAccepted:b,onSelect:t=>{var o,a;const l=((t,o)=>{var a,l,r,n;const s=(0,e.getAppStore)().getState().appConfig,c=(0,e.getAppStore)().getState().browserSizeMode,d=null===(r=null===(l=null===(a=s.widgets)||void 0===a?void 0:a[t])||void 0===l?void 0:l.layouts)||void 0===r?void 0:r.controller,u=i.searchUtils.findLayoutId(d,c,s.mainSizeMode);return null===(n=s.layouts)||void 0===n?void 0:n[u]})(d),r=null!==(a=null===(o=l.order)||void 0===o?void 0:o.length)&&void 0!==a?a:0;M(l,t,{},{},r)},onClose:e=>{(e=>{var t,o;if(!e)return!1;if("controller-add-widget"===(null===(t=e.dataset)||void 0===t?void 0:t.extname))return!0;const a=e.parentElement;return"controller-add-widget"===(null===(o=null==a?void 0:a.dataset)||void 0===o?void 0:o.extname)})(null==e?void 0:e.target)||L()}}))}}})(),d})())}}}));