...
`;function Ei(e){const i=t.hooks.useTranslation(r.defaultMessages),{type:s=t.HoverType.None,onTypeChange:n}=e,a=t.hooks.useEventCallback((e=>{n(e)}));return(0,t.jsx)("div",{css:Pi},(0,t.jsx)(r.ButtonGroup,{role:"listbox",className:"animation-cards"},Zi.map(((e,n)=>((e,n)=>(0,t.jsx)("div",{className:(0,t.classNames)("d-flex flex-column align-items-center card-item",{selected:e.name===s}),key:n},(0,t.jsx)(r.Button,{icon:!0,role:"option","aria-label":i(e.name.toLowerCase()),"aria-selected":e.name===s,className:"d-flex justify-content-center card-content border-0",onClick:()=>a(e.name)},(0,t.jsx)(ki,{size:72})),(0,t.jsx)("div",{className:"card-name flex-grow-1 d-flex align-items-start mt-1"},(0,t.jsx)("span",{className:"text-center card-name-content",title:i(e.name.toLowerCase())},i(e.name.toLowerCase())))))(e,n)))))}const Bi=c(89781),Ri=t.css`
  background-color: transparent;
  position: relative;
  width: 100%;
  height: 72px;
